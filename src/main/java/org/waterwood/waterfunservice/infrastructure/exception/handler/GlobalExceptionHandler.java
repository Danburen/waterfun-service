package org.waterwood.waterfunservice.infrastructure.exception.handler;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handleBusinessException(BusinessException ex){
        ...
        log.info("BusinessException: {} params: {}", ex.getMessage(), Arrays.toString(ex.getParams()));
        log.info("After translation {}", msgSrc.getMessage(ex.getMessage(), ex.getParams(), "error", LOCALE));
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(response);
    }
}